# Contributing to Email Journey Planner

Email Journey Planner is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A planning board for welcome sequences, quote follow-ups, reactivation paths, copy blocks, and exportable email plans.
