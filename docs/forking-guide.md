# Email Journey Planner Forking Guide
...
- Demo promise: Plan lifecycle email sequences with segments, triggers, timing, QA, and launch handoff.
- Fictional sample object: lifecycle journey
...
Fork Email Journey Planner as a public-safe client demo for email marketing workflow. Keep all records fictional, update `src/data.ts`, preserve the readiness board and export flow, and publish only after the build passes.
